...
CREATE TABLE `protection` (
  `protectionID` int NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  `cost` int DEFAULT NULL,
  `protection` int DEFAULT NULL,
  `agility_penalty` int DEFAULT NULL,
  `protection_load` int DEFAULT NULL,
...
INSERT INTO `protection` VALUES (1,'No Protection',0,0,0,0),(2,'Shield',1,0,0,3),(3,'Helm',1,0,0,1),(4,'Shield + Helm',2,0,0,4);
